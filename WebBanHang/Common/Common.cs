...
namespace WebBanHang.Common
{
    public class Common
    {
        private static string EmailAdmin = WebConfigurationManager.AppSettings["EmailAdmin"];
        private static string Password = WebConfigurationManager.AppSettings["PasswordEmail"];
        public static bool SendMail(string name, string subject, string content, string toMail)
        {
            ...
            try
            {
                ...
                MailAddress fromAddress = new MailAddress("sale.webbanhang@gmail.com", name);
