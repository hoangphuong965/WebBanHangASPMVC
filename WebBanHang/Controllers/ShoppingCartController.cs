...
using static WebBanHang.Models.ShoppingCart;
...
namespace WebBanHang.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult ShowCount()
        {
            ...
            if (cart != null)
            {
                var soluong = cart.GetTotalQuantity();
        ...
        public ActionResult AddToCart(int id, int quantity)
        {
            ...
            if (checkProduct != null)
            {
                ...
                var count = cart.GetTotalQuantity() + quantity;
                cart.AddToCart(item, quantity);
                Session["Cart"] = cart;
                code = new { Success = true, msg = "Thêm sản phẩm vào giỏ hàng thành công!", code = 1, Count = count };
            }
            return Json(code);
        }
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            {
                ModelState.AddModelError("CartEmpty", "Giỏ hàng của bạn trống");
                return View();
            }
            if (ModelState.IsValid)
            {
                if(cart != null)
                {
                    ...
                    cart.Items.ForEach(temp => order.OrderDetails.Add(new OrderDetail
                    { 
                    ...
                    WebBanHang.Common.Common.SendMail("ShopOnline", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), WebConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
